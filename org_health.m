...
%!!!!!For some reason, we couldn't figure out how to make the boundarys
%work correctly. In the code below, you can see we tried using if statements
%to see if varible (istart,iend, jstart, jend) was on the edge. If it was,
%we set the value equal to the corresponding opposite side. For some reason
%the program is never entering the if statements!!!!!!!!
%!!!!!!!!!THE GAME STILL WORKS FINE. CONCREGATES AT EDGES!!!!!!!!!
